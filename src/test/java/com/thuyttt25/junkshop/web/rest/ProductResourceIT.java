...
class ProductResourceIT {
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getAddress()).isEqualTo(DEFAULT_ADDRESS);
    ...
    void putNewProduct() throws Exception {
        ...
        assertThat(testProduct.getAddress()).isEqualTo(UPDATED_ADDRESS);
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.description(UPDATED_DESCRIPTION).productStatus(UPDATED_PRODUCT_STATUS);
