...
class FileResourceIT {
    ...
    public static File createEntity(EntityManager em) {
        File file = new File().fileName(DEFAULT_FILE_NAME).fileType(DEFAULT_FILE_TYPE).url(DEFAULT_URL);
        return file;
    }
    ...
    public static File createUpdatedEntity(EntityManager em) {
        File file = new File().fileName(UPDATED_FILE_NAME).fileType(UPDATED_FILE_TYPE).url(UPDATED_URL);
        return file;
    }
    ...
    void putNewFile() throws Exception {
        ...
        updatedFile.fileName(UPDATED_FILE_NAME).fileType(UPDATED_FILE_TYPE).url(UPDATED_URL);
    ...
    void fullUpdateFileWithPatch() throws Exception {
        ...
        partialUpdatedFile.fileName(UPDATED_FILE_NAME).fileType(UPDATED_FILE_TYPE).url(UPDATED_URL);
