...
class DistrictResourceIT {
    ...
    public static District createEntity(EntityManager em) {
        District district = new District().districtName(DEFAULT_DISTRICT_NAME);
        return district;
    }
    ...
    public static District createUpdatedEntity(EntityManager em) {
        District district = new District().districtName(UPDATED_DISTRICT_NAME);
        return district;
    }
    ...
    void putNewDistrict() throws Exception {
        ...
        updatedDistrict.districtName(UPDATED_DISTRICT_NAME);
    ...
    void partialUpdateDistrictWithPatch() throws Exception {
        ...
        partialUpdatedDistrict.districtName(UPDATED_DISTRICT_NAME);
